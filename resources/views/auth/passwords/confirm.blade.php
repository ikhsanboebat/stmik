            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h3 class="text-center m-t-0 m-b-15">
                        <a href="index-2.html" class="logo"><img src="assets/images/logo_white.png" alt="logo-img"></a>
                    </h3>
                    <h4 class="text-muted text-center m-t-0"><b>Reset Password</b></h4>

                    <form class="form-horizontal mt-4" action="https://themesdesign.in/appzia/index.html">
