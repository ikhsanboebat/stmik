    ...
    <div class="content">
        ...
        <div class="">
            <div class="page-header-title">
                <h4 class="page-title text-white">Dashboard | <span class="text-danger">pH <i class="mdi mdi-water"></i></span></h4>
            </div>
        </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    var data = [@foreach ($monitoring as $mon2)
                                                        [ "{{ isset($ia) ? ++$ia : $ia=1 }}", "{{ $mon2->monitoring_ph }}" ],
                                                    @endforeach];
                                                    var dataset = [{ label: "Grafik pH", data: data, color: "#E66060" }];
                                                ...
                                                <table class="table" border="2">
                                                    ...
                                                    @foreach( $mon_table as $mon )
                                                        <tr>
                                                            ...
                                                            <td class="text-default font-weight-bold">Keasaman</td>
                                                            <td class="text-danger font-weight-bold">{{ $mon->monitoring_ph }} pH</td>
